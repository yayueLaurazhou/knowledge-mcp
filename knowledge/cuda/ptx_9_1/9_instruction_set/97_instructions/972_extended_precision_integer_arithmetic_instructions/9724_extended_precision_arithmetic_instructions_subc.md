...
#### 9.7.2.4. [Extended-Precision Arithmetic Instructions: `subc`](https://docs.nvidia.com/cuda/parallel-thread-execution/#extended-precision-arithmetic-instructions-subc)[](https://docs.nvidia.com/cuda/parallel-thread-execution/#extended-precision-arithmetic-instructions-subc "Permalink to this headline")
