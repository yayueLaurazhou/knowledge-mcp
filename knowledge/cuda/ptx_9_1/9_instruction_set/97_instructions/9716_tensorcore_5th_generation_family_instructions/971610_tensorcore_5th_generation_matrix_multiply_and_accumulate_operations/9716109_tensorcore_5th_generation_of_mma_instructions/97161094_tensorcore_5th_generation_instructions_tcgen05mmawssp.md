...
###### 9.7.16.10.9.4. [TensorCore 5th Generation Instructions: `tcgen05.mma.ws.sp`](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-mma-instructions-mma-ws-sp)[](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-mma-instructions-mma-ws-sp "Permalink to this headline")
...
is *MxN*. [Sparse Matrices](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-sparse-matrices) describes the details of the
sparsity.
...
specified in the [Instruction descriptor](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-instruction-descriptor).

The address operand `d-tmem` specifies the address of the destination and the accumulation
matrix `D` in the [Tensor Memory](https://docs.nvidia.com/cuda/parallel-thread-execution/#tensor-memory). The address operand `a-tmem` specifies
the address of the matrix `A` in the [Tensor Memory](https://docs.nvidia.com/cuda/parallel-thread-execution/#tensor-memory). The 64-bit register
...
[Matrix Descriptors](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-matrix-descriptors).
