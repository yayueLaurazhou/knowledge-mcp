...
###### 9.7.16.10.9.1. [TensorCore 5th Generation Instructions: `tcgen05.mma`](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-mma-instructions-mma)[](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-mma-instructions-mma "Permalink to this headline")
...
in [Instruction descriptor](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-instruction-descriptor), specifies
...
accumulate operation is performed on the [Tensor Memory](https://docs.nvidia.com/cuda/parallel-thread-execution/#tensor-memory) of the
...
specifies the address of the matrix `A` in the [Tensor Memory](https://docs.nvidia.com/cuda/parallel-thread-execution/#tensor-memory).
...
matrix descriptor is described in [Matrix Descriptors](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-matrix-descriptors).

The vector operand `disable-output-lane` specifies the lane(s) in the
[Tensor Memory](https://docs.nvidia.com/cuda/parallel-thread-execution/#tensor-memory) that should be not be updated with the resultant
matrix `D`. Elements of the vector operand `disable-output-lane` forms a mask where
each bit corresponds to a lane of the [Tensor Memory](https://docs.nvidia.com/cuda/parallel-thread-execution/#tensor-memory), with least
significant bit of the first element of the vector (leftmost in syntax) corresponding
to the lane 0 of the [Tensor Memory](https://docs.nvidia.com/cuda/parallel-thread-execution/#tensor-memory). If a bit in the mask is 1,
