...
##### 9.7.16.3.3. [Canonical Layouts](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-canonical-layouts)[](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-canonical-layouts "Permalink to this headline")
...
* K-Major, no-swizzling and tf32 type: [Figure 188](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-k-no-swizzle-tf32)

  ![_images/async-warpgroup-k-no-swizzle-tf32.png](./ptx_files/async-warpgroup-k-no-swizzle-tf32.png)


  Figure 188 K major, no-swizzling and tf32 type[](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-k-no-swizzle-tf32 "Permalink to this image")
...
* K-Major, 32B swizzling and tf32 type: [Figure 189](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-k-32b-swizzle-tf32)

  ![_images/async-warpgroup-k-32B-swizzle-tf32.png](./ptx_files/async-warpgroup-k-32B-swizzle-tf32.png)


  Figure 189 K major, 32B swizzling and tf32 type[](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-k-32b-swizzle-tf32 "Permalink to this image")
...
* MN-Major, no-swizzling and bf16 type: [Figure 190](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-mn-no-swizzle-bf16)

  ![_images/async-warpgroup-mn-no-swizzle-bf16.png](./ptx_files/async-warpgroup-mn-no-swizzle-bf16.png)


  Figure 190 MN major, no-swizzling and bf16 type[](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-mn-no-swizzle-bf16 "Permalink to this image")
  ...
  | Encoding of LBO in descriptor | (LBO) >> 4 = 16 |
  | Encoding of SBO in descriptor | (SBO) >> 4 = 8 |
* MN-Major, 32B swizzling and bf16 type: [Figure 191](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-mn-32b-swizzle-bf16)

  ![_images/async-warpgroup-mn-32B-swizzle-bf16.png](./ptx_files/async-warpgroup-mn-32B-swizzle-bf16.png)


  Figure 191 MN major, 32B swizzling and bf16 type[](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-mn-32b-swizzle-bf16 "Permalink to this image")
...
* MN-Major, 64B swizzling and bf16 type: [Figure 192](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-mn-64b-swizzle-bf16)

  ![_images/async-warpgroup-mn-64B-swizzle-bf16.png](./ptx_files/async-warpgroup-mn-64B-swizzle-bf16.png)


  Figure 192 MN major, 64B swizzling and bf16 type[](https://docs.nvidia.com/cuda/parallel-thread-execution/#tcgen05-mn-64b-swizzle-bf16 "Permalink to this image")
