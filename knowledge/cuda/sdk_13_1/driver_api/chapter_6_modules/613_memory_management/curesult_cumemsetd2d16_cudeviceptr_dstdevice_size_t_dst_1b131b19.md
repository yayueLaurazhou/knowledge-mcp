...
Sets the 2D memory range of Width 16-bit values to the specified value us. Height specifies
the number of rows to set, and dstPitch specifies the number of bytes between each row. The
dstDevice pointer and dstPitch offset must be two byte aligned. This function performs fastest
...
CUDA Driver API TRM-06703-001 _vRelease Version  |  253
