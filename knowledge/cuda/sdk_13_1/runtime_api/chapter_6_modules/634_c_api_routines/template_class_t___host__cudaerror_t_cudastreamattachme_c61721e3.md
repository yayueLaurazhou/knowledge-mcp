# template < class T > __host__cudaError_t cudaStreamAttachMemAsync (cudaStream_t stream, T *devPtr, size_t length, unsigned int flags)
...
CUDA Runtime API vRelease Version  |  513
...
CUDA Runtime API vRelease Version  |  514
